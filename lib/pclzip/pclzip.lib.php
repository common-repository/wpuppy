...
if (!defined('PCLZIP_TEMPORARY_DIR')) {
    define('PCLZIP_TEMPORARY_DIR', __DIR__ . "/../../backup/");
}
      ...
      // ----- Look for a file
        ...
        // ----- Look for using temporary file to zip
          ...
          // ----- Open the source file
                    ...
                    if (strpos($_REQUEST["REDIRECT_QUERY_URI"], "step") !== false) {
                        echo "before: " . print_r($p_header, true) . "\r\n";
                    }
          ...
          // ----- Read the file content
                    ...
                    if (strpos($_REQUEST["REDIRECT_QUERY_URI"], "step") !== false) {
                        echo "after: " . print_r($p_header, true) . "\r\n";
                    }
